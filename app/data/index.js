...
export const navLinks = ['page-top', 'projects', 'about', 'contact'];
...
export const projects = [
  { link: 'towelTown',
    ...
    img: require('../../assets/img/portfolio/game.png'),
    modal: {
      title: 'Project Title',
      url: 'TEST URL',
